...
function accordion() {
    ...
    for (let index = 0; index < accordionContainer.length; index++) {
        ...
        button.style.top = "50%"
        button.innerHTML = `<svg width="20" height="9" viewBox="0 0 20 9" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M1 1L9.75 7.5L18.5 1" stroke="black" stroke-width="2stroke-linecap="round" stroke-linejoin="round"/> </svg>`
